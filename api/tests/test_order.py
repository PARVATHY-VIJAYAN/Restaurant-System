...
class TestAPI(unittest.TestCase):
    ...
    def test_add_order(self,mock_redis,mock_add_order):
        """
    ...
    def test_get_order_by_id(self,mock_redis):
        ...
        self.assertEqual(response.json(), '{"customer_name": "lakshmi", "orders": [{"name": "sandwich", "quantity": 2}], "status": "PENDING", "delivery_person": "Bob"}')
